...
//  compile error
//
//  Created by Esmail Mozaffari on 1/13/23.
//
...
// introduced a compile error, removed using namespace std;   // pp. 37-38 in Savitch book explain this line

int main() {
    
    int totalVoters;
    
    int republicanVotes, democraticVotes    // introduced a compile error, removed semicolon in line 20
    ...
    cout.setf(ios::fixed);  / see pp. 30-31 in Savitch book // introduced  compile error, removed a '/" from the comment
    ...
    return(0); // introduced a compile error, removed } at end of program
